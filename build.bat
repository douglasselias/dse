...
cl main.cpp /nologo /W4 /WX /Z7 /fsanitize=address /wd4189 /wd4244 /wd4505 /wd4101 /wd4996 /wd4100 /Fo.\build\ %filename% /link /stack:0x400000,0x400000 /out:build\main.exe
